...
namespace MediaPhone
{
    public class SearchItem
    {
        ...
        public string Title
        {
            get { return trackCensoredName; }
        }

        public string Artwork
        {
            get { return artworkUrl100 ?? artworkUrl60 ?? artworkUrl30; }
        }

        public string RatingAndGenre
        {
            get
            {
                return this.contentAdvisoryRating + " - " + this.primaryGenreName;
            }
        }
    }
