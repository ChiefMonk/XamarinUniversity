...
namespace GreatQuotes.ViewModels
{
    public class MainViewModel : SimpleViewModel
    {
        public MainViewModel()
        {
            ...
            //Commands
            AddQuoteCommand = new Command(async () => await OnAddQuote());
            EditQuoteCommand = new Command<QuoteViewModel>(async vm => await OnEditQuote(vm));
            DeleteQuoteCommand = new Command<QuoteViewModel>(async vm => await OnDeleteQuote(vm));
        }
        ...
        public ICommand EditQuoteCommand { get; set; }
